...
Boop is the AI-native app for pets. Scan your dog once and they become your boop — a digital companion you walk, dress, and shop for — every day, in a single app. Try a jacket on your boop; one tap puts the real jacket in the mail.

The pet economy is already large, recurring, and behaviorally rich. Households walk, feed, dress, gift, and post about their dogs every day. A pet parent's day moves across Chewy or Amazon for food, Rover or the vet for care, Google or Yelp for the dog park. There's no daily consumer surface that holds it all. Boop is the consolidation app across those touchpoints. Every product, brand, and local merchant a pet parent already engages with converges on their boop — by name, breed, neighborhood, and daily routine — an angle the category has never been organized around.

Raising $1M seed on a $10M post-money cap SAFE against the v1 build. $158B US pet category, $428/yr discretionary per dog household.
...
*Gross-margin notes.* Layer 1 IAP nets ~70% after Apple&apos;s 30% standard IAP cut and trivial inference cost per cosmetic. Layer 2 (private label + POD custom merch) is the lowest-margin layer in v1 — print-on-demand fulfillment runs ~30% GM (vendor takes manufacturing + shipping cost), small-batch private-label apparel runs ~50% GM at modest scale, blended ~38% on the v1 mix. Layer 3 (third-party marketplace MoR, Y2+) nets ~80% on the take rate — payment processing, returns reserve, and CS load against a 25–30% gross take on the physical SKU; Boop owns checkout, brands drop-ship. Layers 4 and 5 are SaaS-like (paid-placement billing, sponsored-drop fees) and run at ~85% after payment processing and infra. Blended GM stays roughly flat (~66–67%) across years; Layer 2&apos;s low GM is partially offset by Layer 3&apos;s ~80% as the catalog widens beyond Boop-owned SKUs.

*Phasing.* **v1** ships Layer 1 IAP at iOS launch — live day one. **v1.5** lights up Layer 2 in the months following launch: POD custom merch (human-side and pet-side: t-shirts, hoodies, mugs, posters, totes, bandanas, beds, blankets featuring the user&apos;s dog as design input) integrated and live within ~6 weeks of launch (POD vendor onboarding + checkout integration is the gating work, no inventory required). Layer 2&apos;s small-batch private-label pet apparel core (8–15 starter SKUs: a fleece, a rain jacket, a cooling vest, a few harness/collar options) requires ~3–4 month contract-manufacturer lead time and lands ~3–6 months post-launch, sized to the v1 closed-beta and early-launch demand signal. The v1.5 phasing is intentional: it lets us calibrate the apparel run against real demand instead of pre-committing inventory before the user base exists. **Y2+** layers (3, 4) require broader MAU density before they pay; Layer 3 third-party MoR comes online once v1.5 sell-through data and brand interest are observable, Layer 4 local merchants start in the densest seed metros same window. Both are credible inside an 18–24 month horizon. **Y3+** (Layer 5) requires scale before national brands engage. The seed round funds v1 and v1.5 only; subsequent layers are self-funding from v1.5 revenue and / or a future Series A.
...
<details>
<summary><span class="comp-label">Layer 3 · Marketplace commerce — third-party MoR</span><span class="comp-stat">Faire · Wayfair</span></summary>
<p><strong>Mechanic.</strong> Y2+. Once Layer 2 has demand signal and brand interest is observable, Boop opens the catalog to third-party brand drop-ship: Boop is merchant-of-record, brand partners drop-ship, Boop captures a 25–30% take rate on the physical SKU. Brands sign on for the try-on surface and the customer-relationship-free distribution; Boop captures category breadth (constructed apparel beyond the v1 starter collection, accessories, treats, hardware) without owning the supply chain.</p>
<p><strong>Why this is Y2+, not v1.</strong> Multi-brand MoR requires onboarding ~40 brand drop-ship agreements (SLAs, returns flow, Boop-branded packing slips, Shopify integration) — operationally non-viable as a 2-person v1. By Y2 Boop has v1 sell-through data, a brand-interest pipeline, and the capital to staff brand BD; the integration mechanic itself is established (Faire / Wayfair-style Shopify-rail drop-ship), so the lift is BD velocity not technical novelty.</p>
<p><strong>Comp evidence.</strong> Faire operates a drop-ship marketplace with brands as suppliers; ~$12B in cumulative GMV through 2024 at a ~25% take rate on the supplier-MoR mechanic.<sup>10</sup> Wayfair is the at-scale consumer-vertical MoR proof point: $11.9B 2024 revenue, ~22M active customers, vertical-curated drop-ship-heavy model with Wayfair as merchant.<sup>11</sup> Both prove that vertical-curated MoR works at consumer scale on physical goods that ship from third-party brands.</p>
<p><strong>ARPU math.</strong> $4 yr-3 = ~5% of MAU buying ~1.5× per year at $50 AOV × 20% net take rate after returns reserve and payment processing ($50 × 1.5 × 0.20 = $15 / paying user × 5% × ~5/4 because Layer 3 only ramps mid-Y2 → ~$4 / MAU). Saturation $12 assumes 8% conversion at higher AOV as constructed-apparel and accessory SKUs deepen the catalog. Year-3 figure is intentionally conservative: Layer 3 is the second-act layer, not the v1 anchor.</p>
</details>
...
*Surfaces not modeled in the saturation ceiling (intentionally conservative):* Strava-style power-user analytical subscription; insurance and food-subscription referral fees; pet-sitting and dog-walking marketplace; adoption-listing fees. Each is a credible year-3+ surface and would compound on top of the $50 saturation ARPU above.

## §5 — Bottom-up market sizing

<p class="lede">$33M ARR floor case. $110M ARR stretch. $1.02B at saturation. Bottom-up against §4 ARPU, no top-down TAM math.</p>
...
- **Year-3 floor (the case we underwrite).** ~1.5M MAU (~7% of addressable) at $22 blended ARPU → **~$33M ARR.** Pace anchored to Strava's actual early growth — Strava reached ~1M registered users around year 3 (2011–2012); Boop's case adds a small premium for mobile-native distribution from day one and AI as the cold-start hook.
- **Year-3 stretch.** ~5M MAU (~25% of addressable) at $22 ARPU → **~$110M ARR.** Achievable if the friend graph compounds organic acquisition inside the seed footprint.
- **Saturation ceiling.** Full penetration of the addressable segment at $50 blended ARPU → **~$1.02B ARR.**
...
<p class="lede">No current player composes more than three of Boop&apos;s surfaces. Every player on the matrix is structurally pre-AI.</p>
...
| --- | --- | :---: | ---: | --- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Boop** | AI-native pet app *(iOS launch 2026)* | — | — | IAP + private label MoR (§4) | <span class="yes">✓</span> | <span class="yes">✓</span> | <span class="yes">✓</span> | <span class="yes">✓</span> | <span class="yes">✓</span> | <span class="yes">✓</span> |
...
**2. Apple platform risk.** Layer 1 monetization (cosmetic IAP) sits inside Apple&apos;s standard IAP framework and carries the standard 30% take. Layer 2 (marketplace-of-record physical commerce) is checked out via Stripe outside the IAP framework — physical goods shipped to a real address are explicitly permitted to use third-party payments per Apple&apos;s App Store guidelines, and that policy has been stable for years. The unstable surface is photo-likeness generation, which Apple&apos;s reviewer guidelines have moved on multiple times in the last 24 months. *Resolves through:* App Review submission of the v1 build before commercial launch and explicit alignment with reviewer guidance on AI generation of identifiable likenesses (the dog, not the human). *Mitigation:* Sniffspot&apos;s web-checkout precedent (§6) confirms a web-side fallback for any payment flow Apple objects to.
...
**4. Layer 2 supply-chain execution.** $7 ARPU year-3 from Layer 2 requires (a) a POD vendor live and integrated by day-one (Printful / Printify-class — low risk, multi-vendor available, off-the-shelf) and (b) a small-batch private-label apparel core (8–15 SKUs) manufactured and inventoried for iOS launch — ~3–4 month lead time on a contract manufacturer in China or Vietnam. The execution risk is the apparel core: a missed manufacturing window means v1 launches with POD-only catalog and lower per-MAU revenue until the apparel ships. *Resolves through:* contract manufacturer engaged inside the first 4 months of the seed; first apparel run procured against an order minimum sized to the v1 closed-beta demand signal. *Mitigation:* Layer 2 ARPU degrades gracefully — POD custom merch alone delivers ~$4 / MAU (year-3) without the apparel core; the apparel core is the upside, not the load-bearing v1 number. Layer 3 (third-party marketplace MoR) is a separate Y2+ workstream and not on the v1 critical path.
...
8. Crown &amp; Paw, [*Company site*](https://crownandpaw.com/) and [Inc. Magazine profile](https://www.inc.com/profile/crown-paw) (pet-portraiture POD DTC; nine-figure-revenue cohort representative).
9. The Original BARK Company, [*FY2024 Annual Report*](https://ir.bark.co/) (FY2024 revenue ~$483M; ~2–3M active subscribers on private-label pet merchandise).
10. Faire, [*Company Overview*](https://www.faire.com/about) (cumulative GMV figure per Forbes, [*Faire Built A $12.6 Billion Wholesale Empire*](https://www.forbes.com/sites/amyfeldman/), 2024).
11. Wayfair Inc., [*2024 Annual Report (Form 10-K)*](https://investor.wayfair.com/financial-information/sec-filings) (FY2024 revenue $11.9B; ~22M active customers).
12. Yelp, Inc., [*2024 Annual Report (Form 10-K)*](https://www.yelp-ir.com/).
13. Pinterest, Inc., [*2024 Annual Report (Form 10-K)*](https://investor.pinterestinc.com/).
14. Lev (LEV Maps), company profile via [LinkedIn](https://www.linkedin.com/company/levmaps) and [Crunchbase](https://www.crunchbase.com/organization/lev-maps).
15. Lev, [*FAQs — Bones*](https://levmaps.com/faqs/).
16. Sniffspot, [App Store listing](https://apps.apple.com/us/app/sniffspot-private-dog-parks/id1437699295) and [developer site](https://www.sniffspot.com/).
